...
namespace cafe_management
{
    public partial class Form1 : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-1D1PGSN;Initial Catalog=cafeDB;Integrated Security=True");
            //SqlCommand temp = new SqlCommand();

            //temp.Parameters.Add(new SqlParameter("@latte", SqlDbType.Int, Convert.ToInt32(txtlatte.Text)));

            string query = "insert into cafe (latte, espresso, iced_latte, vale_coffe, cappuccino, african_coffe, " +
                "american_coffee, iced_cappuccino, coffee_cake, red_velvet_cake, black_forest_cake, boston_cream_cake, " +
                "lagos_chocolate_cake, kilburn_chocolate_cake, carlton_hill_chocolate_cake, queen_park_chocolate_cake, " +
                "sub_total) values (@latte, @espresso, @iced_latte, @vale_coffe, @cappuccino, @african_coffe, " +
                "@american_coffee, @iced_cappuccino, @coffee_cake, @red_velvet_cake, @black_forest_cake, @boston_cream_cake, " +
                "@lagos_chocolate_cake, @kilburn_chocolate_cake, @carlton_hill_chocolate_cake, @queen_park_chocolate_cake, " +
                "@sub_total)";

            SqlCommand cmd = new SqlCommand(query,con);
            cmd.Parameters.AddWithValue("@latte", Convert.ToInt32(chklatte.Checked));
            cmd.Parameters.AddWithValue("@espresso", chkespresso.Checked);
            cmd.Parameters.AddWithValue("@iced_latte", chkicedlatte.Checked);
            cmd.Parameters.AddWithValue("@vale_coffe", chkvalecoffe.Checked);
            cmd.Parameters.AddWithValue("@cappuccino", chkcappuccino.Checked);
            cmd.Parameters.AddWithValue("@african_coffe", chkafricancoffee.Checked);
            cmd.Parameters.AddWithValue("@american_coffee", chkamericancoffee.Checked);
            cmd.Parameters.AddWithValue("@iced_cappuccino", chkicedcappuccino.Checked);
            cmd.Parameters.AddWithValue("@coffee_cake", chkcoffee.Checked);
            cmd.Parameters.AddWithValue("@red_velvet_cake", chkredvalvet.Checked);
            cmd.Parameters.AddWithValue("@black_forest_cake", chkblackforest.Checked);
            cmd.Parameters.AddWithValue("@boston_cream_cake", chkbostoncream.Checked);
            cmd.Parameters.AddWithValue("@lagos_chocolate_cake", chklagoschocolate.Checked);
            cmd.Parameters.AddWithValue("@kilburn_chocolate_cake", chkkilburnchocolate.Checked);
            cmd.Parameters.AddWithValue("@carlton_hill_chocolate_cake", chkcarltonhillchocolate.Checked);
            cmd.Parameters.AddWithValue("@queen_park_chocolate_cake", chkqueenparkchocolate.Checked);
